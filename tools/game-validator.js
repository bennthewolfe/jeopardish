...
// Usage: node game-validator.js <file-name>
// Example: node game-validator.js wings-of-fire1.json
...
if (args.length === 0) {
    console.error('Please provide the path to the JSON file.  Usage: node game-validator.js <file-name>');
    process.exit(1);
